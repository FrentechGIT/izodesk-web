    ...
    <section className="pt-32 pb-20 px-6 bg-gradient-to-br from-slate-50 via-white to-orange-50">
      ...
      <div className="max-w-3xl mx-auto mt-16 bg-white rounded-3xl shadow-2xl shadow-slate-200 border border-slate-100 overflow-hidden">
        ...
        <div className="p-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { label: "Aktivních zakázek", value: "24", color: "text-green-600" },
            { label: "Nezaplaceno", value: "142 500 Kč", color: "text-red-500" },
            { label: "Tento měsíc", value: "89 200 Kč", color: "text-brand" },
          ].map((s) => (
